...
function () {
  ...
  return BaseConfig;
}(), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "base", [__WEBPACK_IMPORTED_MODULE_1_mobx__["observable"]], {
  enumerable: true,
  initializer: function initializer() {
    return {
      id: 0,
...
function () {
  ...
  return TagConfig;
}(), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "tags", [__WEBPACK_IMPORTED_MODULE_1_mobx__["observable"]], {
  enumerable: true,
  initializer: function initializer() {
    return [];
  }
