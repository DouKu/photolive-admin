...
var external__axios_ = __webpack_require__(22);
...
var base_config_saveBaseConfig = function saveBaseConfig(_ref) {
  var data = _ref.data,
      params = _ref.params;
  return http.request({
...
/* harmony default export */ var base_config = ({
  saveBaseConfig: base_config_saveBaseConfig
});
// CONCATENATED MODULE: ./store/base-config.js


var base_config__desc, base_config__value, base_config__class;
...
function () {
  ...
  base_config__createClass(BaseConfig, [{
    key: "putConfig",
    value: function () {
      var _putConfig = base_config__asyncToGenerator(
      /*#__PURE__*/
      regenerator__default.a.mark(function _callee(data) {
        var _ref, res;
        ...
        return regenerator__default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return base_config.saveBaseConfig(data);
  ...
  return BaseConfig;
}(), (base_config__applyDecoratedDescriptor(base_config__class.prototype, "putConfig", [external__mobx_["action"]], Object.getOwnPropertyDescriptor(base_config__class.prototype, "putConfig"), base_config__class.prototype)), base_config__class);
